# QuokkaDB documentation

QuokkaDB is an embedded application database for Rust. It stores application models directly in a directory owned by your application, without a separate database server.
