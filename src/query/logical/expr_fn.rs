...
where
    ...
    U: Into<PathComponent>,
{
    Rc::new(Expr::WildcardField(name.into_iter().map(|c| c.into()).collect()))
}
...
{
    Rc::new(Expr::FieldFilters {field, filters: predicates.into_iter().collect()})
}

pub fn gt(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::Gt, value: lit(bson_value)})
}

pub fn gte(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::Gte, value: lit(bson_value)})
}

pub fn lt(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::Lt, value: lit(bson_value)})
}

pub fn lte(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::Lte, value: lit(bson_value)})
}

pub fn within(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::In, value: lit(bson_value)})
}

pub fn eq(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::Eq, value: lit(bson_value)})
}

pub fn ne(bson_value: impl Into<BsonValue>) -> Rc<Expr>
{
    Rc::new(Expr::Comparison {operator: ComparisonOperator::Ne, value: lit(bson_value)})
}
